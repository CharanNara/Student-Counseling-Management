        ...
        for($i=0;$i<$sheetCount;$i++)
        {
            ...
            //echo $ress['Roll']; 
                ...
                if (!empty($name) || !empty($roll)) {
                        ...
                        for($s=2;$s<$j;$s++){
                    $query = "INSERT INTO academic_performance(stuname,sturoll,styear,stbranch,section,semester,examtype,marks,subject) values('".$name."','".$roll."','".$_GET['yr']."','".$_GET['dep']."','".$_GET['sec']."','".$_GET['sem']."','".$_POST['exam']."','".$subs[$s]."','".$headings[$s]."')";
        ...
        for($i=0;$i<$sheetCount;$i++)
        {
            ...
            //echo $ress['Roll']; 
                ...
                if (!empty($name) || !empty($roll)) {
                        ...
                        for($s=2;$s<$j;$s++){
                        $query = "insert into academic_performance(stuname,sturoll,styear,stbranch,section,semester,examtype,marks,subject) values('".$name."','".$roll."','".$_GET['yr']."','".$_GET['dep']."','".$_GET['sec']."','".$_GET['sem']."','".$_POST['exam2']."','".$subs[$s]."','".$headings[$s]."')";
                    $result = mysqli_query($conn, $query);
        ...
        for($i=0;$i<$sheetCount;$i++)
        {
            ...
            //echo $ress['Roll']; 
                ...
                if (!empty($name) || !empty($roll)) {
                        ...
                        for($s=2;$s<$j;$s++){
                         $query = "insert into externals(stuname,sturoll,styear,stbranch,section,semester,grade,subject) values('".$name."','".$roll."','".$_GET['yr']."','".$_GET['dep']."','".$_GET['sec']."','".$_GET['sem']."','".$subs[$s]."','".$headings[$s]."')";
                    $result = mysqli_query($conn, $query);
                
                    if (! empty($result)) {
                        $type2 = "success";
                        $message2 = "Excel Data Imported into the Database";
                    } else {
                        $type2 = "error";
                        $message2 = "Problem in Importing Excel Data";
                    }
                }
                }
            }
...
<!-- Start top-category-widget Area -->
	<section class="top-category-widget-area pt-90 pb-90  " id="stu">
       ...
       <div class="center"><h2>ADD Academic Performance</h2></div>
       <hr>
	</center>
	<div>
       ...
       <nav id="nav-menu-container">
					...
					<ul class="nav-menu">
						...
						<li class="menu-has-children menu-active"><a href="#!"><font color="#191970">ADD SEMESTER-WISE</font></a>
							<ul>
								<li><a href="hod_academic2.php?dep=<?php echo $dep;?>&yr=<?php echo $ye;?>&sec=<?php echo $secs;?>&sem=I-SEMESTER">Semester-I</a></li>
							
								<li><a href="hod_academic2.php?dep=<?php echo $dep;?>&yr=<?php echo $ye;?>&sec=<?php echo $secs;?>&sem=II-SEMESTER">Semester-II</a></li>
...
<label><h4><?php echo $ye." ".$_GET['sem'];?></h4></label>
   ...
   <br>
    <h5>Choose the Examination type : </h5>
<font color="text-black">
    <input type="radio" name="exam" value="mid1"/> MID I &nbsp;&nbsp;
    <input type="radio" name="exam" value="mid2"/> MID II &nbsp;&nbsp;
    <input type="radio" name="exam" value="mid3"/> MID III &nbsp;&nbsp;
...
<font color="text-black">
    ...
    <input type="radio" name="ext" value="ext"/> EXTERNAL &nbsp;&nbsp;
    ...
    <h3>Import Excel File into MySQL Database </h3><br>
            <div>
                <label>Choose Excel
                    File</label> <input type="file" name="file"
                    id="file" accept=".xls,.xlsx">
                <button type="submit" id="submit" name="import3"
                    class="btn-submit">Import</button>
                    <button type="submit" id="submit" name="delet"
                    class="btn-submit">Deletee</button>
    ...
    <div id="response" class="<?php if(!empty($type2)) { echo $type2 . " display-block"; } ?>"><font color="red"><?php if(!empty($message2)) { echo $message2; } ?></font></div>
    ...
    <h5>Choose the Examination type : </h5>
<font color="text-black">
    <input type="radio" name="exam2" value="mid1"/> MID I &nbsp;&nbsp;
    <input type="radio" name="exam2" value="mid2"/> MID II &nbsp;&nbsp;
    <input type="radio" name="exam2" value="mid3"/> MID III &nbsp;&nbsp;
...
<font color="text-black">
    ...
    <input type="radio" name="ext2" value="ext"/> EXTERNAL &nbsp;&nbsp;
