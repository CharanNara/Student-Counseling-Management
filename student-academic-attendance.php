...
$query="SELECT * FROM student_detail WHERE Roll='".$_SESSION['student']."' ";
			...
			<div class="row align-items-center justify-content-between d-flex">
				...
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						...
						<li><a href="logout.php?whom=student">Logout</a></li>
					</ul>
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				...
				<div class="banner-content col-lg-8 col-md-12">
					<br><br><br><br><br><h1 class="text-white">
				        
					</h1>
					<h4><?php echo $_GET['sem'];?></h4>
					<br>
				<h4 class="text-white">VIEW</h4><br>
					<h4 class="text-white"><?php echo $row['Name'];?>'s</h4>

					<div class="courses pt-20">
						
					             
						
						<a href="semesters/student-academic-results.php?sem=<?php echo $sem;?>&sems=<?php echo $sems;?>&yrs=<?php echo $yrs;?>" data-wow-duration="1s" data-wow-delay=".9s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Academic Performance</a>
						<a href="semesters/student-sems.php?sem=<?php echo $sem;?>&sems=<?php echo $sems;?>& yrs=<?php echo $yrs;?>" data-wow-duration="1s" data-wow-delay="1.2s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Monthly Attendance
						</a>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							...
							<a href="counseling/student-counseling-notes.php?numsem=<?php echo $_GET['indsem'];?>" target="_blank">
								<div class="thumb">
