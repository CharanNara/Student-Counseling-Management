       	...
       	<nav id="nav-menu-container">
					...
					<ul class="nav-menu">
						...
						<li class="menu-has-children menu-active"><a href="#!"><font color="#191970">SEMESTER</font></a>
							<ul>
								<li><a href="academic-attendance-ask.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=I-BTech I-SEMESTER&sems=I-SEMESTER&indsem=I-SEMESTER& yrs=I Year">Semester-I</a></li>
							
								<li><a href="academic-attendance-ask.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=I-BTech II-SEMESTER&sems=II-SEMESTER&indsem=II-SEMESTER& yrs=I Year">Semester-II</a></li>
							
								<li><a href="academic-attendance-ask.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=II-BTech I-SEMESTER&sems=I-SEMESTER&indsem=III-SEMESTER& yrs=II Year">Semester-III</a></li>

								<li><a href="academic-attendance-ask.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=II-BTech II-SEMESTER&sems=II-SEMESTER&indsem=IV-SEMESTER& yrs=II Year">Semester-IV</a></li>
								<!--<li><a href="academic-attendance-ask.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=III-BTech I-SEMESTER&sems=I-SEMESTER&indsem=V-SEMESTER& yrs=III Year" data-toggle="modal" data-target="#myModal">Semester-V</a></li>-->
								<li><a href="academic-attendance-ask.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=III-BTech I-SEMESTER&sems=I-SEMESTER&indsem=V-SEMESTER& yrs=III Year">Semester-V</a></li>
								<li><a href="academic-attendance-ask.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=III-BTech II-SEMESTER&sems=II-SEMESTER&indsem=VI-SEMESTER& yrs=III Year">Semester-VI</a></li>
								<li><a href="academic-attendance-ask.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=IV-BTech I-SEMESTER&sems=I-SEMESTER&indsem=VII-SEMESTER& yrs=IV Year">Semester-VII</a></li>
								<li><a href="academic-attendance-ask.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=IV-BTech II-SEMESTER&sems=II-SEMESTER&indsem=II-SEMESTER& yrs=IV Year">Semester-VIII</a></li>
							</ul>
						</li>
						<li class="menu-has-children menu-active"><a href=""><font color="#191970">VIEW</font></a>
							<ul>
								<li><a href="fac-student_backlog.php?roll=<?php echo $_GET['stuRoll'];?>&br=<?php echo $rowl['fac_branch'];?>">Backlogs</a></li>
								<li><a href="fac-add-student.php?br=<?php echo $rowl['fac_branch'];?>">Condonation/Detention</a></li>
							</ul>
						</li>
					</ul>
      ...
      <div class = "modal-content">
         ...
         <div class = "modal-header">
            ...
            <h4 class = "modal-title" id = "myModalLabel">
               --Select student's Professional Elective-I
            </h4>
         </div>
         
         <div class = "modal-body">
            <form action="academic-attendance-ask.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=III-BTech I-SEMESTER&sems=I-SEMESTER&indsem=V-SEMESTER& yrs=III Year" method="POST">
            	<input type="radio" name="rd" value="OOAD :Object Oriented">OOAD: Object Oriented Analysis and Design<br>
            	<input type="radio" name="rd" value="MC :Mobile Computing">MC: Mobile Computing
...
<!--remove upper comment to use modal-->
<br>
<hr>
<?php 
    ...
    <div class="outer-container">
        ...
        <form action="" method="POST">
			...
			<tr><td>Category : </td><td>
                 <input type="text" name="cat"  placeholder="Convener(OC/BC/SC..etc) or Management quota" <?php echo $mode;?> value="<?php echo trim($row['category']);?>" size="20">
				</td></tr>
<tr></tr><tr></tr><tr></tr><tr></tr><tr></tr>
			<tr><td>Year Of Joining AGI : </td><td>

            <select name="yoj"<?php echo $selectmode;?>>
                                     ...
                                     <?php
                                     echo "<option selected disabled='true'>--SELECT YEAR--</option>";
			...
			</td><td></td><td></td><td></td><td></td></tr><tr><td></td><td><label><b><font color="text-black"><?php echo $row['yearOfJoin'];?></font></b></label></td></tr>
		</table>
