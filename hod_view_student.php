       	...
       	<nav id="nav-menu-container">
					...
					<ul class="nav-menu">
						...
						<li class="menu-has-children menu-active"><a href="#!"><font color="#191970">SEMESTER</font></a>
							<ul>
								<li><a href="hod-academic-attendance.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=I-BTech I-SEMESTER&sems=I-SEMESTER&indsem=I-SEMESTER& yrs=I Year">Semester-I</a></li>
							
								<li><a href="hod-academic-attendance.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=I-BTech II-SEMESTER&sems=II-SEMESTER&indsem=II-SEMESTER& yrs=I Year">Semester-II</a></li>
							
								<li><a href="hod-academic-attendance.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=II-BTech I-SEMESTER&sems=I-SEMESTER&indsem=III-SEMESTER& yrs=II Year">Semester-III</a></li>

								<li><a href="hod-academic-attendance.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=II-BTech II-SEMESTER&sems=II-SEMESTER&indsem=IV-SEMESTER& yrs=II Year">Semester-IV</a></li>
								<li><a href="hod-academic-attendance.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=III-BTech I-SEMESTER&sems=I-SEMESTER&indsem=V-SEMESTER& yrs=III Year">Semester-V</a></li>
								<li><a href="hod-academic-attendance.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=III-BTech II-SEMESTER&sems=II-SEMESTER&indsem=VI-SEMESTER& yrs=III Year">Semester-VI</a></li>
								<li><a href="hod-academic-attendance.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=IV-BTech I-SEMESTER&sems=I-SEMESTER&indsem=VII-SEMESTER& yrs=IV Year">Semester-VII</a></li>
								<li><a href="hod-academic-attendance.php?roll=<?php echo $_GET['stuRoll'];?>&stuname=<?php echo $studentName  ?> & sem=IV-BTech II-SEMESTER&sems=II-SEMESTER&indsem=II-SEMESTER& yrs=IV Year">Semester-VIII</a></li>
							</ul>
						</li>
...
<center><h5>ADD IMAGE</h5></center>
    ...
    <div class="outer-container">
        ...
        <form action="" method="POST">
            ...
            </select><label><b><?php echo $row['yearOfJoin'];?></b></label>
			</td></tr>
		</table>
