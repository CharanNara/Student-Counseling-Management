...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Director | ADD ATTENDANCE</title>
       ...
       <nav id="nav-menu-container">
					...
					<ul class="nav-menu">
						...
						<li class="menu-has-children menu-active"><a href="#!"><font color="#191970">ADD SEMESTER-WISE</font></a>
							<ul>
								<li><a href="director_attendance3.php?dep=<?php echo $dep;?>&yr=<?php echo $ye;?>&sec=<?php echo $secs;?>&sem=I-SEMESTER">Semester-I</a></li>
							
								<li><a href="director_attendance3.php?dep=<?php echo $dep;?>&yr=<?php echo $ye;?>&sec=<?php echo $secs;?>&sem=II-SEMESTER">Semester-II</a></li>
...
<font color="text-black">
    ...
    <input type="radio" name="smonth" value="month_3"/> MONTH-4 &nbsp;&nbsp;
...
<font color="text-black">
    ...
    <input type="radio" name="smonth2" value="month_3"/> MONTH-4 &nbsp;&nbsp;
