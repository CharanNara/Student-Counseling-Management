...
if(isset($_POST['add']))
{
	...
	$sql="INSERT INTO student_detail(Roll,Name,department,styear,section,counselor) VALUES('".$roll."','".$name."','".$_GET['br']."','".$yr."','".$sec."','".$coun."')";
	...
	<div class="container">
			<div class="row align-items-center justify-content-between d-flex">
				<div id="logo">
					...
					<ul class="nav-menu">
						<li><a href="facultyPage.php"><font color="black">HomePage</font></a></li>
						
						
						<li><a href="logout.php?whom=staff"><font color="black">Logout</font></a></li>
		...
		<div class="container-login100">
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50">
				<form action="" class="login100-form validate-form" method="POST">
					...
					<p>OF</p>
					<p>BRANCH: <?php echo $_GET['br'];?></p><br>
					...
					<div class="wrap-input100 rs1 validate-input" data-validate="Year is required">
						<input class="input100" type="text" name="yr" placeholder="I Year/II Year/III Year/IV Year" value="<?php echo $sec;?>">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>
                   ...
                   <div class="wrap-input100 rs1 validate-input" data-validate="Counselor is required">
						<input class="input100" type="text" name="coun" placeholder="Name of the Counselor" readonly="true" value="<?php echo $rowl['fac_name'];?>">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>
