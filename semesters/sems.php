...
<head>
	...
	<meta charset="UTF-8">
	<!-- Site Title -->
	<title>Faculty-Monthly Attendance</title>
...
$rowsub=mysqli_fetch_array($ressub2);
 if(empty($rowlex) || empty($rowsub))
        {?>
...
<br>
<?php
if(mysqli_num_rows($prores)>0 && mysqli_num_rows($ressub) > 0)
{
    ?>
     <table class="progress-table-wrap" border="2">
        <thead>
