...
$main_sql="SELECT * FROM student_detail WHERE Roll='".$_SESSION['student']."'";
...
<!-- Start top-category-widget Area -->
   ...
   <br><br>
		...
		<div class="container">
			<br>
			  <center>
                <h3><?php echo $main_row['Name'];?></h3><br>
...
<div style="text-align: center;"><h3><?php echo $m1;?></h3></div>
   ...
   // $sqlSelect = "SELECT * FROM monthly_attendance";
    ...
    $sqlex="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_1' ";
    $sqlex2="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_1' AND styear='".$_GET['yrs']."' AND Semester='".$_GET['sems']."'";
...
$ressub3=mysqli_query($conn,$sqlsub2);
    ...
    $ropsql="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_1' AND styear='".$_GET['yrs']."' AND Semester='".$_GET['sems']."'";
...
$pro="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_1' AND styear='".$_GET['yrs']."' AND Semester='".$_GET['sems']."' ";
...
<div style="text-align: center;"><h3><?php echo $m2;?></h3></div>
   ...
   // $sqlSelect = "SELECT * FROM monthly_attendance";
    //$result = mysqli_query($conn, $sqlSelect);
   $sqlex="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_2' ";
    $sqlex2="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_2' AND styear='".$_GET['yrs']."' AND Semester='".$_GET['sems']."'";
    $reslex=mysqli_query($conn,$sqlex);
    $reslex2=mysqli_query($conn,$sqlex2);
    $rowlex=mysqli_fetch_array($reslex2);
     if(empty($rowlex))
...
$ressub3=mysqli_query($conn,$sqlsub2);
    ...
    $ropsql="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_2' AND styear='".$_GET['yrs']."' AND Semester='".$_GET['sems']."'";
    $resrop=mysqli_query($conn,$ropsql);
    $rop=mysqli_fetch_array($resrop);
    $sqlsub="SELECT * FROM subjects_table WHERE subject_year='".$rop['styear']."' AND sub_branch='".$rop['stbranch']."' AND subject_semester='".$rop['Semester']."' ";
    $ressub=mysqli_query($conn,$sqlsub);
...
$pro="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_2' AND styear='".$_GET['yrs']."' AND Semester='".$_GET['sems']."' ";
$prores=mysqli_query($conn,$pro);
$prow=mysqli_fetch_array($prores);
?>
<center><h4 style="float: right;right: 0px"><?php echo "Month :".$prow['month_name']."   ";?></h4></center>
...
<div style="text-align: center;"><h3><?php echo $m3;?></h3></div>
   ...
   // $sqlSelect = "SELECT * FROM monthly_attendance";
    //$result = mysqli_query($conn, $sqlSelect);
    $sqlex="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_3' ";
    $sqlex2="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_3' AND styear='".$_GET['yrs']."' AND Semester='".$_GET['sems']."'";
    $reslex=mysqli_query($conn,$sqlex);
    $reslex2=mysqli_query($conn,$sqlex2);
    $rowlex=mysqli_fetch_array($reslex2);
     if(empty($rowlex))
...
$ressub3=mysqli_query($conn,$sqlsub2);
    ...
    $ropsql="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_3' AND styear='".$_GET['yrs']."' AND Semester='".$_GET['sems']."'";
    $resrop=mysqli_query($conn,$ropsql);
    $rop=mysqli_fetch_array($resrop);
    $sqlsub="SELECT * FROM subjects_table WHERE subject_year='".$rop['styear']."' AND sub_branch='".$rop['stbranch']."' AND subject_semester='".$rop['Semester']."' ";
    $ressub=mysqli_query($conn,$sqlsub);
...
$pro="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_3' AND styear='".$_GET['yrs']."' AND Semester='".$_GET['sems']."' ";
$prores=mysqli_query($conn,$pro);
$prow=mysqli_fetch_array($prores);
?>
<center><h4 style="float: right;right: 0px"><?php echo "Month :".$prow['month_name']."   ";?></h4></center>
...
<div style="text-align: center;"><h3><?php echo $m4;?></h3></div>
   ...
   // $sqlSelect = "SELECT * FROM monthly_attendance";
    //$result = mysqli_query($conn, $sqlSelect);
   $sqlex="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_4' ";
    $sqlex2="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_4' AND styear='".$_GET['yrs']."' AND Semester='".$_GET['sems']."'";
    $reslex=mysqli_query($conn,$sqlex);
    $reslex2=mysqli_query($conn,$sqlex2);
    $rowlex=mysqli_fetch_array($reslex2);
     if(empty($rowlex))
...
$ressub3=mysqli_query($conn,$sqlsub2);
    ...
    $ropsql="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_4' AND styear='".$_GET['yrs']."' AND Semester='".$_GET['sems']."'";
    $resrop=mysqli_query($conn,$ropsql);
    $rop=mysqli_fetch_array($resrop);
    $sqlsub="SELECT * FROM subjects_table WHERE subject_year='".$rop['styear']."' AND sub_branch='".$rop['stbranch']."' AND subject_semester='".$rop['Semester']."' ";
    $ressub=mysqli_query($conn,$sqlsub);
...
$pro="SELECT * FROM month_attendance WHERE stname='".$main_row['Name']."' AND month_count='month_4' AND styear='".$_GET['yrs']."' AND Semester='".$_GET['sems']."' ";
$prores=mysqli_query($conn,$pro);
$prow=mysqli_fetch_array($prores);
?>
<center><h4 style="float: right;right: 0px"><?php echo "Month :".$prow['month_name']."   ";?></h4></center>
