...
{
	if($_POST['email']!=$row['director_email'] || $_POST['pass']!=$row['director_password'])
		{
			$error['email']="** E-mail or password invalid **";

		}else if($_POST['email']==$row['director_email'] && $_POST['pass']==$row['director_password']) {
			$email=$_POST['email'];
			$pass=$_POST['pass'];
			$_SESSION['dirEmail']=$_POST['email'];
				...
				<div id="logo">
					...
					<ul class="nav-menu">
						...
						<li class="menu-has-children"><a href=""><font color="black">Login</font></a>
							...
							<li><a href="elements.html">As Head Of Dept</a></li>
