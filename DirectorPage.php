...
$query="SELECT  * FROM director_table WHERE director_email='".$_SESSION['dirEmail']."' ";
		...
		<div class="container">
			<div class="row d-flex align-items-center justify-content-center">
				...
				<div class="banner-content col-lg-8 col-md-12">
				        ...
				        <?php echo "Director Page";?>
					</h1>
					<h3><?php  echo $row['director_name']; ?></h3>
					<br>
					<br>
					...
					<div class="courses pt-20">
						...
						<a href="director3.php?who=hod" data-wow-duration="1s" data-wow-delay=".6s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">HOD</a>
						<a href="director1-2.php?who=Staff" data-wow-duration="1s" data-wow-delay=".9s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Staff</a>
						<a href="director1.php?who=Student" data-wow-duration="1s" data-wow-delay="1.2s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Student
						</a>
