			...
			<div class="row d-flex align-items-center justify-content-center">
				...
				<div class="banner-content col-lg-8 col-md-12">
					...
					<div class="courses pt-20">
						...
						<a href="semesters/hod-academic-results.php?stuname=<?php echo $studentName;?>&sem=<?php echo $sem;?>&sems=<?php echo $sems;?>&yrs=<?php echo $yrs;?>" data-wow-duration="1s" data-wow-delay=".9s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Academic Performance</a>
						<a href="semesters/hod-sems.php?stuname=<?php echo $studentName;?>&sem=<?php echo $sem;?>&sems=<?php echo $sems;?>& yrs=<?php echo $yrs;?>" data-wow-duration="1s" data-wow-delay="1.2s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Monthly Attendance
						</a>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							...
							<a href="counseling/hod-counseling-notes.php?roll=<?php echo $_GET['roll'];?>&student=<?php echo $_GET['stuname'];?>&numsem=<?php echo $_GET['indsem'];?>" target="_blank">
								<div class="thumb">
