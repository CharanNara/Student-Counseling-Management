...
if(isset($_GET['who']))
{
	...
	if($whoo=='Staff')
	{
		$sql="SELECT * FROM faculty_table WHERE fac_branch='".$_GET['dep']."' order by fac_id";
...
if(isset($_POST['search'])){
	...
	{
	$sql2="SELECT * FROM faculty_table WHERE fac_id='$usr' and fac_branch='".$_GET['dep']."'";
...
{
	$sql2="SELECT * FROM faculty_table WHERE fac_branch='".$_GET['dep']."' order by fac_id";
	$result=mysqli_query($conn,$sql2);
	if(mysqli_num_rows($result)>0)
...
<head><title>Director | Faculty</title></head>
...
<nav id="nav-menu-container">
	...
	<div class="section-top-border">
              ...
              ?>
							<div class="country"><a href="director-fac-student.php?facname=<?php echo $row['fac_name'];?>&facdept=<?php echo $row['fac_branch'];?>"><?php echo $row['fac_name'];?></a></div>
