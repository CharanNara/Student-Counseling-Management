		...
		<div class="container">
			<div class="row align-items-center justify-content-between d-flex">
				...
				<nav id="nav-menu-container">
					<ul class="nav-menu">
						<li><a href="DirectorPage.php">Home</a></li>
						
						<li class="menu-has-children menu-active"><a href="">Pages</a>
							<ul>
								<li><a href="elements.html">Student</a></li>
							</ul>
						</li>
						
						<li><a href="logout.php?whom=director">Logout</a></li>
					</ul>
			...
			<div class="row d-flex align-items-center justify-content-center">
				...
				<br>
					...
					<div class="courses pt-20">
						...
						<a href="semesters/director-academic-results.php?stuname=<?php echo $studentName;?>&sem=<?php echo $sem;?>&sems=<?php echo $sems;?>&yrs=<?php echo $yrs;?>" data-wow-duration="1s" data-wow-delay=".9s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Academic Performance</a>
						<a href="semesters/director-sems.php?stuname=<?php echo $studentName;?>&sem=<?php echo $sem;?>&sems=<?php echo $sems;?>& yrs=<?php echo $yrs;?>" data-wow-duration="1s" data-wow-delay="1.2s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Monthly Attendance
						</a>
				...
				<div class="col-lg-4">
					<div class="single-cat-widget">
						<div class="content relative">
							...
							<a href="counseling/director-counseling-notes.php?roll=<?php echo $_GET['roll'];?>&student=<?php echo $_GET['stuname'];?>&numsem=<?php echo $_GET['indsem'];?>" target="_blank">
								<div class="thumb">
