			...
			<div class="row d-flex align-items-center justify-content-center">
				...
				<div class="banner-content col-lg-8 col-md-12">
					<br><br><br><br><br><br><h1 class="text-white">
				        <?php echo $row['hod_branch']." HOD ";?>
					</h1>
					<h3><?php echo $row['hod_name'];?></h3>
					<br><br>
					...
					<div class="courses pt-20">
						...
						<a href="hod3.php?who=Staff" data-wow-duration="1s" data-wow-delay=".9s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Staff</a>
						<a href="hod2.php?who=Student" data-wow-duration="1s" data-wow-delay="1.2s" class="primary-btn transparent mr-10 mb-10 wow fadeInDown">Student
						</a>
